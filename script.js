...
function countdown() {
    const christmasDate = new Date(christmas); // Converts the target date string to a date object
    ...
    if (seconds <= 0) {
        ...
        document.getElementById("blast-off-message").innerHTML = "Merry Christmas!";

        // Add the celebration image
        const imageElement = document.createElement('img');
        imageElement.src = 'F:\Douglas Kings\Software Development\GitHub\Javascript\Projects\Count Down Blast Off Christmas - Copy\assets\img\Christmas.jpg'; 
        imageElement.alt = 'Merry Christmas Celebration';
